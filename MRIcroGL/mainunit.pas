...
begin
 ...
 // Hide unnecessary controls for MedVirtuso UI
SliceBox.Visible := false;        // hides 2D Slice Selection
CoordLabel.Visible := false;      // hides Coordinates label
XCoordEdit.Visible := false;
YCoordEdit.Visible := false;
ZCoordEdit.Visible := false;

LayerDarkLabel.Visible := false;  // hides Darkness
LayerDarkEdit.Visible := false;

LayerBrightLabel.Visible := false; // hides Brightness
LayerBrightEdit.Visible := false;

LayerAlphaLabel.Visible := false; // hides Opacity
LayerAlphaTrack.Visible := false;

// Optional: make sidebar cleaner
LineBox.Top := Smooth2DCheck.Top + 60;
